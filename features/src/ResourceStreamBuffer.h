...
/*
This file is part of mjin-resource:
    http://bitbucket.org/ogstudio/mjin-resource
...
#ifndef MJIN_RESOURCE_RESOURCE_STREAM_BUFFER_H
#define MJIN_RESOURCE_RESOURCE_STREAM_BUFFER_H

#include <mjin-resource/Resource.h>
...
struct ResourceStreamBuffer : std::streambuf
{
    ...
    // We implement 'seekoff()' to support 'seekg()' calls.
...
#endif // MJIN_RESOURCE_RESOURCE_STREAM_BUFFER_H
