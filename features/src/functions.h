...
#ifndef OPENSCENEGRAPH_CROSS_PLATFORM_EXAMPLES_FUNCTIONS_H
#define OPENSCENEGRAPH_CROSS_PLATFORM_EXAMPLES_FUNCTIONS_H
...
// FEATURE LoggingAndroid/Include
// FEATURE LoggingDefault/Include

// Log message using platform specific tools.
void platformLog(const char *message)
{
    // FEATURE LoggingAndroid/Impl
    // FEATURE LoggingDefault/Impl
}
...
// FEATURE RenderinIOS/Include
// FEATURE RenderinIOS/Impl
...
#endif // OPENSCENEGRAPH_CROSS_PLATFORM_EXAMPLES_FUNCTIONS_H
